...
Decisions that would be expensive to reverse, or that someone will otherwise
re-litigate in six months. Each records what was decided, why, and what it cost.

| # | Decision | Date |
|---|---|---|
| [0001](0001-standalone-from-home-app.md) | Receipts ships standalone, outside the Home App suite | 2026-09-16 |
| [0002](0002-single-repo.md) | One repository for api, ui, and docs | 2026-09-16 |
